...
const {addExpenseByUserId} = FinanceManagerAPI;
...
export default function AddExpenseItem() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            await axios.post(addExpenseByUserId, requestBody);
            navigate(-1);
          } catch (error) {
            console.error("Unable to add new expense:", error);
            setError(true);
          }
    }
    ...
    return (
        ...
        <div className="edit_expense-header">
            ...
            <div className="edit_expense-title"> Add New Expense</div>
        </div>
        <div>
